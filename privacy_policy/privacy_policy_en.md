...
The online service provides the professional and technical basis for notices of calls for tenders from federal procurement systems or for the publication of these in the National Contract Notices Service (BKMS) as well as TED. This involves setting up an intermediary service is established that receives the state-specific procurement data and forwards it to the BKMS and TED for the information provision.
