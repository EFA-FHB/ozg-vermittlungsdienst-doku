...
|--------------|--------------------------|-----------------------------|---------------------|----|
| All validators | 28.05.2024 | 08/2024 | Validation process aborts if an announcement under _<cac:AwardingCriterion>_ contains the tag _<efac:AwardCriterionParameter>_ twice. A __500 Internal Sever Error__ error is returned | __In progress__ |
