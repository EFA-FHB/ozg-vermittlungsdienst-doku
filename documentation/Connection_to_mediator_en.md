...
Notices can be sent to the mediation service via the mediation service's [REST API](#connection-via-rest-api) or via the [eDelivery Network PEPPOL](#connection-via-PEPPOL-(in-implementation)) (in implementation).
<br>
