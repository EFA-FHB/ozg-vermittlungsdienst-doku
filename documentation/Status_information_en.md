...
The following status combinations, can be transmitted when requesting the status of a Upper Threshold award.

| TED status | DöE status | status description |
| ----------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| PENDING | PENDING | The announcement has been accepted by the eSender for further processing. Transmission of the announcement to TED and to the announcement service is still pending. |
