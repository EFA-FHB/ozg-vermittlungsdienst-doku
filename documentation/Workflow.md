...
<br><br>
Bei erfolgreicher Einlieferung wird die Bekanntmachung weiter prozessiert. Abhängig davon, ob es sich um ein eForms-Dokument zu einer Bekanntmachung oberhalb oder unterhalb der EU-Schwellenwerte handelt, werden Bekanntmachungen entweder direkt an den Bekanntmachungsservice (unterhalb der EU-Schwellenwertes) oder an den eSender-Hub (oberhalb der EU-Schwellenwerte) weitergeleitet (siehe [Ober- oder Unterschwellenvergabe](/documentation/Upper-or_lower-threshold-award.md)). Einlieferungen im Format des Standards eForms-DE werden im eSender-HUB in das europäische Format eForms-EU transformiert. Welche eForms-Versionen die einzelnen Komponenten unterstützen, ist hier [eForms-Support](/documentation/eForms_support.md) dokumentiert.
<br><br>
