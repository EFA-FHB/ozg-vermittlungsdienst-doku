...
|--------------|--------------------------|-----------------------------|---------------------|----|
| Alle Services des DÖE außer BKMS (Produktion + Staging) | 14.06.2024 | 14.06.2024 | Derzeit ist die Produktions- und Stagingumgebung nicht erreichbar aufgrung von Problemen im Rechenzentrum. Wir erwarten eine zeitnahe Behebung | __In Arbeit__ |
