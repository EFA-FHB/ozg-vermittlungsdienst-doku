...
|--------------|--------------------------|-----------------------------|---------------------|----|
| Alle Validatoren | 28.05.2024 | 08/2024 | __BR-DE-23__: Validierungsprozess bricht ab wenn eine Bekanntmachung unter _<cac:AwardingCriterion>_ den Tag _<efac:AwardCriterionParameter>_ doppelt beinhaltet. Es wird ein __500 Internal Sever Error__ Fehler zurückgegeben | __In Arbeit__ |
