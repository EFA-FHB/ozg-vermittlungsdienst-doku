...
|--------------|--------------------------|-----------------------------|---------------------|----|
| TED Apps for eForms | 31.10.2024 | nicht bekannt | Validierungsstörung: Es werden Formulare 16, 17 und 29 in eForms-SDK-1.7 Version bei der Validierung nicht richtig erkannt. Dies führt bei der Übermittlung zur Ablehnungen | __In Klärung__ |
